...
<template>
    <div class="flex flex-col w-full h-full max-h-screen bg-zinc-50">
        <h2
            class="text-xl flex-wrap wrap-break-word font-bold text-zinc-800 text-center shrink-0 mb-4"
        >
            Compras Realizadas
        </h2>
                ...
                <table class="w-full text-left text-sm text-zinc-600">
                    ...
                    >
                        <tr>
                            ...
                            <th class="px-6 py-4">Nombre del Comprador</th>
                            <th class="px-6 py-4">Producto</th>
                            <th class="px-6 py-4">Cantidad</th>
                            <th class="px-6 py-4">Precio p/u</th>
